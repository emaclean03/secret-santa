...
<template>
  ...
  <nav class="mx-auto w-full z-30 mt-6">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
      <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto mt-2 lg:mt-0 text-black p-4 lg:p-0 z-20">
        <ul class="list-reset lg:flex justify-end flex-1 items-center">
          <li class="mr-3">
            <Link  v-if="$page.props.user" :href="route('dashboard')" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">Dashboard</Link>
          </li>
          <li class="mr-3"  v-if="canLogin && !$page.props.user">
              <Link :href="route('login')" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition ">Log in</Link>
          </li>
          <li class="mr-3"  v-if="canLogin && !$page.props.user">
            <Link  :href="route('register')" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">Register</Link>
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="pt-24">
    <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      ...
      <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
        <p class="uppercase tracking-loose w-full">Mystery Drawing</p>
        ...
        <div class="w-5/6 sm:w-1/2 p-6">
          ...
          <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
            ...
            <div v-if="!$page.props.user">
              <Link v-if="canRegister && !$page.props.user"  :href="route('register')" class="ml-4 text-xs text-gray-700 dark:text-gray-500 underline">Register</Link>
              <div class="text-sm inline"> or <Link v-if="canLogin && !$page.props.user" :href="route('login')" class="text-xs text-gray-700 dark:text-gray-500 underline">Log in</Link></div>
            </div>
          </h3>
      ...
      <div class="flex flex-wrap flex-col-reverse sm:flex-row">
        ...
        <div class="w-full sm:w-1/2 p-6 mt-6">
          <div class="align-middle">
            ...
            <p class="text-gray-600 mb-8">
             Create a new list with a list of your friends. You will have a secret link that your friends can access. Your friends will not have to register to use this link.
