            ...
            <div>
                    ...
                    <div class="layout__inner"
                        ...
                        <div class="column"
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                                <div style="mso-line-height-rule: exactly;line-height: 29px;font-size: 1px;">&nbsp;
                                </div>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p style="Margin-top: 0;Margin-bottom: 0;">
                                        * You do not have to take any action at this time.<br/>
                                        * Your "drawn name" is the person you will be getting a gift for.
                                </div>
                            </div>
                ...
                <div class="layout fixed-width stack"
                    ...
                    <div class="layout__inner"
                        ...
                        <tr class="layout-fixed-width" style="background-color: #f5f6f8;">
                        ...
                        <div class="column narrow"
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h3 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3d3b3d;font-size: 17px;line-height: 26px;text-align: center;">
                                        <span style="text-decoration: inherit;color: #525252;"><strong>When</strong></span>
                                    </h3>
                                </div>
                            </div>
                        ...
                        <div class="column wide"
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p style="Margin-top: 0;Margin-bottom: 0;">{{$secretList->event_date}}</p>
                                </div>
                            </div>
                                ...
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h3 style='Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3d3b3d;font-size: 17px;line-height: 26px;font-family: Montserrat,"DejaVu Sans",Verdana,sans-serif;text-align: center;'>
                                        <span class="font-montserrat" style="text-decoration: inherit;"><span
                                                    style="text-decoration: inherit;color: #525252;"><strong>Budget</strong></span></span>
                                    </h3>
                                </div>
                            </div>
                ...
                <div class="layout fixed-width stack"
                    ...
                    <div class="layout__inner"
                        ...
                        <div class="column narrow"
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <h3 style='Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #3d3b3d;font-size: 17px;line-height: 26px;font-family: Montserrat,"DejaVu Sans",Verdana,sans-serif;text-align: center;'>
                                        <span class="font-montserrat" style="text-decoration: inherit;"><span
                                                    style="text-decoration: inherit;color: #525252;"><strong>Drawn name: </strong></span></span>
                                    </h3>
                                </div>
                            </div>
                        ...
                        <div class="column wide"
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;Margin-bottom: 24px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p style="Margin-top: 0;Margin-bottom: 0;"><strong>{{$details->full_name}}</strong>
                                    </p>
                                </div>
                            </div>
